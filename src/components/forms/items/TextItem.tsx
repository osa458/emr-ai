...
export function TextItem({ item, answer, onChange, readOnly, suggestion, onApplySuggestion }: ItemProps) {
  ...
  return (
    <div className="space-y-1.5">
      ...
      <textarea
        ...
        rows={4}
        className="w-full px-3 py-2 border rounded-md text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-slate-50 disabled:cursor-not-allowed resize-y"
      />
